(function() {
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function startGame(name) {
            // FIX 1: Guardar explícitamente el nombre en la variable global que leen otros scripts
            ...
            // 2. Actualizar etiqueta sobre la cabeza del personaje 3D local
        ...
        if (btnUnir) {
            btnUnir.addEventListener('click', () => {
                // FIX 2: Limpiar espacios antes de validar la longitud del código
