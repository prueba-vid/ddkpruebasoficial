// ==========================================
// UIPC.JS - CONTROLES PARA PC (CORREGIDO)
// ==========================================
...
function updatePCMovement() {
    ...
    // CORREGIDO: W incrementa movimiento hacia adelante (-1 en Z/Y) y S hacia atrás (+1)
...
window.addEventListener('mousemove', e => {
    ...
    // Compatibilidad multi-navegador y touchpad para deltas de movimiento
    const movementX = e.movementX || e.mozMovementX || e.webkitMovementX || 0;
    const movementY = e.movementY || e.mozMovementY || e.webkitMovementY || 0;

    // Procesar movimiento si hay valores de desplazamiento
    if (movementX !== 0 || movementY !== 0) {
        window.touchState.camTheta -= movementX * 0.0025 * sens;
        window.touchState.camPhi -= movementY * 0.002 * sens;

        // Limitar la inclinación vertical para evitar giros bruscos o inversión de cámara
        const minPhi = 0.1;
